    ...
    <div className="max-w-4xl mx-auto py-16 px-4">
      ...
      >
        ...
        <motion.div
           ...
           className="mb-16"
        >
          <h1 className="text-4xl font-black text-gray-900 uppercase tracking-tightest italic underline decoration-indigo-600 decoration-4 underline-offset-8">Terms and Conditions</h1>
          <p className="text-[10px] font-black text-indigo-600 mt-8 uppercase tracking-[0.2em] italic">Last Updated: April 2026</p>
        </motion.div>
        ...
        <div className="mt-16 space-y-12">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              <span className="text-xs font-black text-indigo-600 font-mono tracking-tighter opacity-40 group-hover:opacity-100 transition-opacity">[01]</span>
              <h2 className="text-sm font-black text-gray-900 uppercase tracking-widest italic">Acceptance of Terms</h2>
            </div>
            <p className="text-gray-500 font-bold text-sm tracking-tight leading-relaxed italic border-l-2 border-gray-100 pl-6 group-hover:border-indigo-600 transition-colors">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              <span className="text-xs font-black text-indigo-600 font-mono tracking-tighter opacity-40 group-hover:opacity-100 transition-opacity">[02]</span>
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              <span className="text-xs font-black text-indigo-600 font-mono tracking-tighter opacity-40 group-hover:opacity-100 transition-opacity">[03]</span>
            ...
            <ul className="space-y-4 pl-6 border-l-2 border-gray-100 group-hover:border-indigo-600 transition-colors">
              {[
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              <span className="text-xs font-black text-indigo-600 font-mono tracking-tighter opacity-40 group-hover:opacity-100 transition-opacity">[04]</span>
              <h2 className="text-sm font-black text-gray-900 uppercase tracking-widest italic">Limitation of Liability</h2>
            </div>
            <div className="space-y-4 border-l-2 border-gray-100 pl-6 group-hover:border-indigo-600 transition-colors">
              ...
              <p className="text-red-600/70 font-bold text-sm tracking-tight leading-relaxed italic">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              <span className="text-xs font-black text-indigo-600 font-mono tracking-tighter opacity-40 group-hover:opacity-100 transition-opacity">[05]</span>
